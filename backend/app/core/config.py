...
class Settings(BaseSettings):
    ...
    momentum_donchian_lookback: int = 5
    ...
    momentum_vol_spike_mult: float = 0.15
    ...
    momentum_min_atr_pct: float = 0.0005
    ...
    momentum_breakout_buffer_atr: float = 0.0
    ...
    trading_symbols: str = (
        ...
        "CHZ_USDT,KAVA_USDT,BIGTIME_USDT,CORE_USDT,STRK_USDT,"
