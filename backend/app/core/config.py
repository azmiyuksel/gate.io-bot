...
class Settings(BaseSettings):
    ...
    trading_symbols: str = (
        ...
        "TON_USDT,AAVE_USDT,ENA_USDT,EIGEN_USDT,GRT_USDT,ALGO_USDT,SAND_USDT,"
        "MANA_USDT,AXS_USDT,GALA_USDT,THETA_USDT,FLOW_USDT,CRV_USDT,SNX_USDT,"
        "COMP_USDT,SUSHI_USDT,DYDX_USDT,LDO_USDT,APE_USDT,ZEC_USDT,DASH_USDT,"
        "HBAR_USDT,VET_USDT,CAKE_USDT,RUNE_USDT,GMX_USDT,BLUR_USDT,ENJ_USDT,"
        "CHZ_USDT,XEC_USDT,KAVA_USDT,ALPACA_USDT,BIGTIME_USDT,CORE_USDT,STRK_USDT,"
        "ETHFI_USDT,EIGEN_USDT,OMNI_USDT,REZ_USDT,DMAIL_USDT,BLST_USDT,MKR_USDT,"
        "XAI_USDT,PORTAL_USDT,ZRO_USDT,LAST_USDT,IO_USDT,ZK_USDT,QKMC_USDT"
    )
